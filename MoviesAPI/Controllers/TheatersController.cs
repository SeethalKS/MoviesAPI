...
namespace MoviesAPI.Controllers
{
    public class TheatersController : CustomBaseController
    {
        ...
        [HttpPost]
        public async Task<CreatedAtRouteResult> Post([FromBody] TheatreCreationDTO theatreCreationDTO )
        {
            return await Post<TheatreCreationDTO, Theater, TheaterDTO>(theatreCreationDTO, routeName: "GetTheaterById");

        }

        [HttpPut("{id:int}")]
        public async Task<IActionResult> Put(int id, [FromBody] TheatreCreationDTO theatreCreationDTO)
        {
            return await Put<TheatreCreationDTO, Theater>(id, theatreCreationDTO);
        }
        [HttpDelete("{id:int}")]
